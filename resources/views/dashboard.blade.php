...
<div class="row">
            ...
            <div class="col-lg-4 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h4 style="font-size:17px;"><strong><?php echo $total->totalPedidos;?></strong></h4>
                  <p>Compras</p>
                </div>
                <div class="icon">
                  <i class="ion ion-bag"></i>
                </div>
                <a href="{{url('compras/pedidos')}}" class="small-box-footer">Compras <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
        ...
        var PieData = [
          <?php 
            ...
            foreach ($productosvendidos as $reg)
                       ...
                       $cadena=$cadena.$color.'",label: "'.$reg->producto.'" },';
                       $cont=$cont+1;
                       }
            echo $cadena;?>
        ];

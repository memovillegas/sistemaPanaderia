...
<html>
  <head>
    ...
    <title>Panadería San Juan Bosco</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('compras/pedidos')}}"><i class="fa fa-circle-o"></i> Pedidos</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('acceso/empleado')}}"><i class="fa fa-circle-o"></i> Empleado</a></li>
              </ul>
            </li>
             <li>
              <!-- <a href="#">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Ventas Web</h3>
